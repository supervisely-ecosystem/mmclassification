...
class SuperviselyLoggerHook(LoggerHook):
    ...
    def _update_charts(self, log_dict, fields, epoch_float):
        if log_dict['mode'] == 'train':
            ...
            if 'time' in log_dict.keys():
                fields.extend([
                    ...
                    # {"field": "data.chartMemory.series[0].data", "payload": [[epoch_float, log_dict["memory"]]], "append": True}, # @TODO: add memory to log_dict
                ])
    ...
    def _log_info(self, log_dict, runner, batch_idx, mode):
        ...
        self._update_charts(log_dict, fields, epoch_float)
        g.api.app.set_fields(g.task_id, fields)
